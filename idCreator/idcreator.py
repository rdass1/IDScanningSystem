...
blankIDCardFront = "Slide1.PNG"  # Link to the template of the front side of the ID
blankIDCardBack = "Slide2.PNG"    # Link to the template of the back side of the ID
IDCARD_WIDTH = 305 # Constant pixel width of an ID Card
IDCARD_HEIGHT = 205 # Constant pixel height of an ID Card 
fontFile = "Calibri Regular.ttf"                # Link to text file that will be used on the ID card
...
def create_cardfront(holder_name, holder_id, holder_role, holder_ISS, holder_DOB, holder_gender, holder_pronouns, holder_height, holder_eyecolor, holder_haircolor, quote, holder_pic):
    ...
    temp_pic = None
    try:
        temp_pic = Image.open(holder_pic)
    except:
        print("Invalid Picture Input")
        temp_pic = Image.open("johndoepic.jpg")
