...
function displayUserData(user){
    ...
    if(user.role == "Employee" && sessionUser.role == "Admin"){
        btnHtml= `
            <div class="mr-1 md:mr-4">
                <button id="id-modal" class="bg-sky-500 rounded text-white px-8 py-2" >Login</button>
            </div>
            <div class="mr-1 md:mr-4">
                <button id="id-modal" class="bg-sky-500 rounded text-white px-8 py-2" >Create ID</button>
            </div>
    ...
    displayHtml += `
      <div class="p-2">
        ...
        <div class="grow w-96" style="background-color:#F8F8F8;">
      ...
      <h3 class="text-xl font-medium text-gray-900 dark:text-white">Edit Member</h3>
                      <div class="overflow-y-scroll m-0" style="height:24rem">
                          <div>
                              ...
                              <input type="file" id="" name="memberIDImage" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                          </div>
                          <div>
                          ...
                          <div>
                              ...
                              <input type="text" name="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required value="${user.role}">
                          </div>
                          <div>
  ...
  function idForm(user){
    ...
    `;
    if(user.cardIDData !== undefined){
      displayHtml += `
            <div>
            <label for="memberHeightFT" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Height</label>
            <div class="flex gap-2">
                <input type="number" id="" name="memberHeightFT" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="ft" value="${user.cardIDData.heightFT}">
                <input type="number" id="" name="memberHeightIN" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="in" value="${user.cardIDData.heightIN}">
            </div>
            
        </div>
        <div>
            <label for="memberEyeColor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Eye Color</label>
            <input type="text" id="" name="memberEyeColor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="${user.cardIDData.eyeColor}">
        </div>
        <div>
            <label for="memberHairColor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hair Color</label>
            <input type="text" id="" name="memberHairColor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="${user.cardIDData.hairColor}">
        </div>
      `;
    ...
    displayHtml += `
      ...
      <label for="memberHeightFT" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Height</label>
      <div class="flex gap-2">
          <input type="number" id="" name="memberHeightFT" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="ft">
          <input type="number" id="" name="memberHeightIN" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="in">
      </div>
      
  </div>
  <div>
      <label for="memberEyeColor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Eye Color</label>
      <input type="text" id="" name="memberEyeColor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" >
  </div>
  <div>
      <label for="memberHairColor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hair Color</label>
      <input type="text" id="" name="memberHairColor" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
  </div>
    `;
